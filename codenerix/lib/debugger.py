...
from codenerix_lib.debugger import *  # noqa: F403,F401 # pylint: disable=unused-import,wildcard-import,unused-wildcard-import  # pyright: ignore[reportWildcardImportFromLibrary]
...
========================== W A R N I N G ===============================
DJANGO-CODENERIX: you have imported 'lib.debugger' which is DEPRECATED
it will not work in newer versions, instead use 'codenerix_lib.debugger'
