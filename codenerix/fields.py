...
from codenerix.widgets import BootstrapWysiwygInput
from codenerix.widgets import Date2TimeInput
from codenerix.widgets import FileAngularInput
from codenerix.widgets import GenReCaptchaInput
from codenerix.widgets import MultiBlockWysiwygInput
...
class GenReCaptchaField(forms.CharField):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        On compiled verstion of the library, don't forget to add before the
        codenerix.js scripts to add:
