...
- [CODENERIX Full ERP DEMO](https://erp.codenerix.com).

You can find some working examples in GITHUB at [django-codenerix-examples](https://github.com/codenerix/django-codenerix-examples) project.
...
3. Clone the [CODENERIX Examples](https://github.com/codenerix/django-codenerix-examples) project:
...
You can get access to online documentation at [CODENERIX Documentation](http://doc.codenerix.com).

You can find all documentation in GITHUB at [django-codenerix-documentation](https://github.com/codenerix/django-codenerix-documentation) project.
